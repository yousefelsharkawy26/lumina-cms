  ...
  try {
    ...
    const settings = await prisma.storeSettings.upsert({
      ...
      update: {
        ...
        twoFactorAdmin,
        sessionTimeout:
          sessionTimeout !== undefined ? Number(sessionTimeout) : undefined,
        maintenanceMode,
        apiVersion,
      },
      create: {
        ...
        sessionTimeout:
          sessionTimeout !== undefined ? Number(sessionTimeout) : 24,
        maintenanceMode:
          maintenanceMode !== undefined ? maintenanceMode : false,
